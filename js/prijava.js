...
$.fn.boom = function (e) {
    ...
    for (i = 0; i < num; i++) {
        ...
        var sec = Math.floor(Math.random() * 1700) + 1000;             //floor i random
        ...
        group.push({ shape: shape, x: x, y: y });//oblici po x i y koordinati
    }
...
$(function () {                                     //kad se klikne na taj button onda ovo sve
